...
<tr><td style="padding:24px 0 0;"><p style="margin:0;font-size:12px;color:#9ca3af;">You are receiving this because you subscribed to transcript notifications. <a href="${baseUrl()}/subscriptions" style="color:#9ca3af;">Manage subscriptions</a>.</p></td></tr>
