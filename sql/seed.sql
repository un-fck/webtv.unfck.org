...
-- ── feeds (current state after migrations 005 + 007) ─────────────────────────
-- Note: migration 005 originally seeded a 'press-conferences' feed which was
-- replaced by 'daily-press-briefing' in migration 007. Only the post-007 state
-- is reproduced here.
