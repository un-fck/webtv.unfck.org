...
**Eval system only:** `AZURE_SPEECH_KEY`, `AZURE_SPEECH_ENDPOINT`, `GEMINI_API_KEY`, `ELEVENLABS_API_KEY`, `GROQ_API_KEY`, `HF_TOKEN`, `GOOGLE_APPLICATION_CREDENTIALS`, `GOOGLE_CLOUD_BUCKET`.
